				...
				case "a":
					while (filaA_Llena == false) {
						...
						if (ocupadoA[numeroAsiento - 1] == false) {
							System.out.println(
									"Asiento numero " + filaA[numeroAsiento - 1] + " en la fila A fue ocupado.");
				...
				case "b":
					...
					while (filaB_Llena == false) {
						...
						if (ocupadoB[numeroAsiento - 1] == false) {
							System.out.println(
									"Asiento numero " + filaB[numeroAsiento - 1] + " en la fila B fue ocupado.");
				...
				case "c":
					...
					while (filaC_Llena == false && seguirEligiendoFila == true) {
						...
						if (ocupadoC[numeroAsiento - 1] == false) {
							System.out.println(
									"Asiento numero " + filaC[numeroAsiento - 1] + " en la fila C fue ocupado.");
